    ...
    <div className='flex flex-wrap'>
        <div className='w-full  lg:w-1/2'>
            <div className='flex flex-col items-center lg-items-start'>
                ...
                initial='hidden'
                animate='visible'
                 className='pb-16 text-4xl font-thin tracking-tight lg:mt-16 lg:text-7xl tracking-tighter'>Abhishek Singh </motion.h1>
                <motion.span 
        ...
        <div className='w-full  lg:w-1/2 lg:p-8'>
            <div className='flex w-full h-[60vh]  justify-center'>
                ...
                className='rounded-md object-cover' src={profile_pic} alt="" />
            </div>
        </div>
    </div>
    </div>
